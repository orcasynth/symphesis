  ...
  render() {
    return (
      <div>
        ...
        <i className="fa fa-map-marker fa-lg" aria-hidden="true"></i> {this.props.room} <button className="exit-button" onClick={() => this.props.leaveRoom()}>Exit room</button><br></br>
        </div>
